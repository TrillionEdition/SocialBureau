...
export default function AddClientPortfolio() {
  ...
  const handleFileUpload = (itemId, files) => {
    if (files) {
      updatePortfolioItem(itemId, 'files', Array.from(files));
    }
  };
                      ...
                      <label
                        ...
                        className={`block border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-all ${
                          formData.photos.length >= 4
                            ...
                            : 'border-zinc-700 hover:border-red-500 hover:bg-red-500/5'
                        }`}
                      >
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-xs text-red-400 mt-2">
                            {formData.photos.length >= 4
                              ...
                              : `${4 - formData.photos.length} photos remaining`}
                          </p>
                        </div>
                      </label>
                    </div>
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium">
                            Selected Photos ({formData.photos.length}/4)
                          </span>
                          <span
                            className={`text-xs ${
                          ...
                          >
                            {formData.photos.length >= 3
                              ...
                              : `${3 - formData.photos.length} more required`}
                          </span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          ...
                          {/* Empty slots */}
                          {Array.from({ length: 4 - formData.photos.length }).map(
                            (_, index) => (
                              <div
                                key={`empty-${index}`}
                                className="aspect-square bg-zinc-900/40 border-2 border-dashed border-zinc-700 rounded-lg flex items-center justify-center"
                              >
                                <div className="text-center p-4">
                                  <div className="text-gray-500 mb-1">Empty Slot</div>
                                  <div className="text-xs text-gray-600">Upload to fill</div>
                                </div>
                              </div>
                            )
                          )}
                    ...
                    {formData.photos.length > 0 && formData.photos.length < 3 && (
                      <div className="text-red-400 text-sm bg-red-500/10 border border-red-500/30 rounded-lg p-3 mt-4">
                        <div className="flex items-center">
                          ...
                          Please upload at least {3 - formData.photos.length} more photo(s)
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={addSkill}
                        className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-xl"
                      >
                        +
                      </button>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      {skills.map((skill, i) => (
                        <div
                          key={i}
                          className="flex items-center bg-red-600/20 border border-red-600 text-red-300 px-3 py-1 rounded-full text-sm"
                        >
                          {skill}
                          <button
                            type="button"
                  ...
                  {portfolioItems.map((item, index) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        value={item.role}
                        onChange={(e) =>
                          updatePortfolioItem(item.id, 'role', e.target.value)
                        }
                        className="w-full bg-black/40 border border-zinc-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
                        required
                      />
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <input
                          ...
                          value={item.tools}
                          onChange={(e) =>
                            updatePortfolioItem(item.id, 'tools', e.target.value)
                          }
                          className="bg-black/40 border border-zinc-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
                          required
                        />
                ...
                >
                  ...
                  <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6 mt-8">
                    ...
                    <ul className="text-sm text-gray-400 space-y-2">
                      ...
                      <li>• You can remove your portfolio at any time</li>
                      <li>
                        • We may feature your work in marketing materials (with consent)
                      </li>
                    </ul>
                  </div>
                  <div className="bg-gradient-to-r from-red-900/20 to-red-800/10 border border-red-800/30 rounded-xl p-6 mt-6">
