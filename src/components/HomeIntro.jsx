  ...
  return (
    <div className="w-full text-white bg-black overflow-hidden">
      <section className="z-20">
        <div className="flex flex-col items-center justify-center px-4 py-10 md:pt-20 bg-black overflow-hidden">
          {/* Main Content with Entrance Animation */}
          <motion.div 
            initial={{ y: 60, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1.2, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
            className="relative z-10 text-white text-left px-10 w-full"
          >
