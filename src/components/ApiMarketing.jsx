...
// // //             description: 'Developers typically discover integrations through organic search, peer recommendations, and technical communities. We focus on reaching high-intent audiences while optimizing developer portals.',
// // //             items: [
...
// // //             description: 'Our API consultant engagements audit existing developer journeys to identify adoption barriers and monetization opportunities.',
// // //             items: [
...
// // //             description: 'Platforms require positioning that communicates both technical excellence and business value simultaneously.',
// // //             items: [
...
// // //             description: 'The first successful call predicts long-term retention. We optimize the complete journey from discovery through sustained usage.',
// // //             items: [
...
// // //     const faqs = [
// // //         {
// // //             question: 'What exactly is API marketing?',
// // //             answer: 'API marketing targets developers through technical documentation and code examples instead of sales presentations. Developers evaluate APIs by testing them directly, not through feature demos.'
// // //         },
// // //         {
// // //             question: 'Why do developers ignore traditional marketing?',
// // //             answer: 'Developers trust peer recommendations over sales content. They want to test functionality before committing time, so traditional sales tactics create friction.'
// // //         },
// // //         {
// // //             question: 'What is TTFFC and why does it matter?',
// // //             answer: 'TTFFC means Time to First Finished Call—how quickly developers make their first successful API request. The faster they succeed, the more likely they continue using your platform.'
// // //         },
// // //         {
// // //             question: 'How does developer portal SEO differ?',
// // //             answer: 'Developer portal SEO targets technical queries like "Python payment example" instead of broad terms. Focus on tutorials, documentation, and optimize GitHub repositories.'
// // //         },
// // //         {
// // //             question: 'What role do functional sandboxes play?',
// // //             answer: 'Sandboxes let developers test your API immediately without setup. They provide sample data and realistic scenarios for quick validation, increasing conversion rates.'
// // //         },
// // //         {
// // //             question: 'Why work with Social Bureau?',
// // //             answer: 'We specialize in developer-focused marketing with a team of former developers. We focus on real metrics: activation rates, API usage growth, and revenue.'
// // //         },
// // //         {
// // //             question: 'How do low-code connectors impact adoption?',
// // //             answer: 'Low-code connectors on Zapier and Make expand your market to business users. Serve both audiences: full documentation for developers, simple connectors for business users.'
// // //         },
// // //         {
// // //             question: 'What is API monetization?',
// // //             answer: 'API monetization turns integrations into revenue through usage-based pricing or tiered subscriptions. Usage-based pricing scales naturally with customer growth.'
// // //         },
// // //         {
// // //             question: 'How do partner ecosystems accelerate growth?',
// // //             answer: 'Partner ecosystems multiply adoption through integrations with popular tools. Platforms with strong ecosystems see more partner-driven adoption than direct marketing alone.'
// // //         },
// // //         {
// // //             question: 'What metrics should we track?',
// // //             answer: 'Track developer acquisition cost, activation rate, integration retention, and API usage growth. These metrics reveal adoption barriers and value problems.'
// // //         }
// // //     ];
...
// // //                             <br />
// // //                             <span className="font-light">Revenue Engines</span>
// // //                         </motion.h2>
...
// // //                         >
// // //                             Social Bureau, based in Kochi, Kerala, helps SaaS platforms, cloud providers, and technology companies achieve measurable growth through developer-centric strategies.
// // //                         </motion.p>
...
// // //                                                 <h4 className="text-red-400 font-semibold text-md uppercase tracking-wider mb-4">
// // //                                                     Key Features:
// // //                                                 </h4>
...
// // //                             {/* Accent Line */}
// // //                             <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-[2px] bg-red-600 rounded-full" />
...
// // //                                 whileHover={{ scale: 1.05 }}
// // //                                 whileTap={{ scale: 0.97 }}
// // //                                 className="bg-red-600 text-white px-10 py-4 rounded-md text-xs tracking-[0.25em] font-bold uppercase hover:bg-red-700 transition-all duration-200"
// // //                             >
...
// // //                                         <ChevronDown
// // //                                             size={20}
// // //                                             className={`text-red-400 transition-transform duration-300 flex-shrink-0 ${openFaq === index ? 'rotate-180' : ''}`}
// // //                                         />
// // //                                     </button>
// // //                                     {openFaq === index && (
...
// //         <div className="max-w-7xl mx-auto">
// //             <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-8 sm:mb-12">Latest Articles</h2>
// //             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
// //                 {[...Array(3)].map((_, i) => (
// //                     <div key={i} className="bg-gray-900 rounded-lg p-4 sm:p-6">
// //                         <h3 className="text-white font-bold mb-2 text-sm sm:text-base">Blog Post {i + 1}</h3>
// //                         <p className="text-gray-400 text-xs sm:text-sm">Read our latest insights...</p>
// //                     </div>
// //                 ))}
// //             </div>
// //         </div>
...
// //                 {/* Services Section - Horizontal Scroll (All Screens) */}
// //                 <section ref={servicesSectionRef} className="relative bg-black text-white h-[400vh]">
// //                     <div className="sticky top-0 flex h-screen items-center overflow-hidden">
...
// //                             <div className="min-w-[100vw] sm:min-w-[50vw]" />
// //                         </motion.div>
// //                     </div>
// //                 </section>
...
// //                 {/* Why Choose Us - Horizontal Scroll (All Screens) */}
// //                 <section ref={whyChooseSectionRef} className="relative bg-black text-white h-[300vh]">
// //                     <div className="sticky top-0 flex h-screen items-center overflow-hidden">
...
//                         <motion.div style={{ x: servicesX }} className="flex h-full gap-0">
//                             {services.map((service, index) => (
//                                 <div key={index} className={`flex items-center min-w-fit px-[2vw] sm:px-[5vw] ${index === 0 ? 'pl-[4vw] sm:pl-[10vw]' : ''} ${index === services.length - 1 ? 'pr-[20vw] sm:pr-[10vw]' : ''}`}>
//                                     <div className="flex flex-col md:flex-row items-center justify-center gap-3 sm:gap-6 lg:gap-12 h-full py-12 sm:py-20 w-[550px] sm:w-[900px]">
//                                         {/* Service Card */}
//                                         <div className="relative h-[280px] sm:h-[350px] w-[240px] sm:w-[300px] md:w-[400px] lg:w-[450px] flex-shrink-0">
//                                             <div className="relative w-full h-full border border-gray-800 bg-black/40 backdrop-blur-lg rounded-2xl p-4 sm:p-8 flex flex-col">
...
//                         <motion.div style={{ x: whyChooseX }} className="flex h-full gap-0">
//                             {whyChooseUs.map((item, index) => (
//                                 <div key={index} className={`flex items-center min-w-fit px-[2vw] sm:px-[5vw] ${index === 0 ? 'pl-[4vw] sm:pl-[10vw]' : ''} ${index === whyChooseUs.length - 1 ? 'pr-[20vw] sm:pr-[10vw]' : ''}`}>
//                                     <div className="flex flex-col md:flex-row items-center justify-center gap-3 sm:gap-6 lg:gap-6 h-full py-12 sm:py-20 w-[450px] sm:w-[600px]">
