...
// // //     opacity: 1,
// // //     transition: {
// // //       staggerChildren: 0.15, // Smooth interval between boxes
// // //     }
// // //   }
// // // };
...
// // //     className="grid md:grid-cols-12 gap-12 py-32 border-b border-gray-200"
// // //   >
// // //     <div className="md:col-span-4 sticky top-32 self-start">
// // //       <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-3xl font-medium text-[#1a1a1a] mb-4">
// // //         {title}
// // //       </h3>
// // //       <p className="text-gray-500 font-light text-sm tracking-wide leading-relaxed">{desc}</p>
// // //     </div>
...
// // // export const CareerCTA = () => {
// // //   return (
// // //     <div className="bg-[#fafafa] text-[#1a1a1a] font-sans px-6 md:px-24">

// // //       {/* 1. Joining Guidelines */}
// // //       <Section title="Joining Guidelines" desc="Understand the step-by-step process to join SocialBureau.">
// // //         {[
...
// // //         ].map((item, i) => (
// // //           <motion.div key={i} variants={itemVariants} className="border-l border-gray-300 pl-8 py-2">
// // //             <h4 className="text-xl font-medium mb-2">{item.title}</h4>
// // //             <p className="text-gray-500 text-sm font-light max-w-lg">{item.text}</p>
// // //           </motion.div>
// // //         ))}
// // //       </Section>
...
// // //         {/* Editorial Header */}
// // //         <div className="mb-16">
// // //           <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-4xl text-[#1a1a1a] mb-4">
// // //             Company Policy
// // //           </h3>
// // //           <p className="text-gray-500 font-light tracking-widest uppercase text-[10px]">
// // //             Our values, ethics, and professional expectations.
// // //           </p>
// // //         </div>

// // //         {/* Staggered Policy Grid */}
// // //         <motion.div 
...
// // //               className="bg-white p-10 border border-gray-100 transition-all duration-500 hover:border-red-200 hover:shadow-lg group"
// // //             >
// // //               <span className="text-[9px] uppercase tracking-[0.3em] text-red-600 font-bold block mb-4">
// // //                 Policy 0{i + 1}
// // //               </span>
// // //               <h4 className="text-xl font-medium mb-3 text-[#1a1a1a] font-serif">{item.title}</h4>
...
// // //       {/* 3. CTA */}
// // //       <motion.div variants={itemVariants} className="py-32 text-center">
// // //         <h2 style={{ fontFamily: "'Playfair Display', serif" }} className="text-5xl font-medium mb-12">Ready to define the future?</h2>
// // //         <a href="https://www.linkedin.com/company/socialbureau-in" 
// // //            className="border border-[#1a1a1a] px-12 py-4 text-[11px] font-bold uppercase tracking-[0.3em] hover:bg-[#1a1a1a] hover:text-white transition-all duration-500">
// // //           Submit Application
// // //         </a>
// // //       </motion.div>
// // //     </div>
...
// // const policyData = [
// //   { title: "Transparency", desc: "Open feedback loops and clear, measurable growth pathways." },
// //   { title: "Equal Opportunity", desc: "A meritocratic culture that celebrates diverse perspectives." },
// //   { title: "Confidentiality", desc: "Maintaining the highest standards of ethics and data integrity." },
// //   { title: "Performance", desc: "Advancement anchored in impact, skill, and creative output." },
// //   { title: "Creative Freedom", desc: "Empowering every team member to pitch and lead initiatives." }
// // ];
...
// // const cardVariant = {
// //   hidden: { opacity: 0, scale: 0.95, y: 20 },
// //   show: { opacity: 1, scale: 1, y: 0, transition: { duration: 0.8, ease: luxuryEase } }
// // };
...
// //       {/* 2. Company Policy */}
// //       <motion.section
// //         className="py-32 border-b border-gray-200"
// //         initial="hidden"
// //         whileInView="show"
// //         viewport={{ margin: "-20% 0px -20% 0px" }}
// //         variants={containerVariants}
// //       >
// //         <div className="mb-16">
// //           <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-3xl font-medium text-[#1a1a1a] mb-4">Company Policy</h3>
// //           <p className="text-gray-500 font-light tracking-widest uppercase text-[10px]">Our values, ethics, and professional expectations.</p>
// //         </div>

// //         <motion.div className="grid md:grid-cols-3 gap-6" variants={gridContainer}>
// //           {policyData.map((item, i) => (
// //             <motion.div key={i} variants={cardVariant} className="bg-white p-10 border border-gray-100 hover:border-red-200 transition-all duration-500 hover:shadow-lg">
// //               <span className="text-[9px] uppercase tracking-[0.3em] text-red-600 font-bold block mb-4">Policy 0{i + 1}</span>
// //               <h4 className="text-xl font-medium mb-3 font-serif">{item.title}</h4>
...
//   show: { opacity: 1, y: 0, transition: { duration: 1, ease: luxuryEase } }
// };

// // --- Reusable Section Wrapper ---
// const Section = ({ title, desc, children, sideImage }) => {
//   return (
//     <motion.div
//       initial="hidden"
//       whileInView="show"
...
//     >
//       <div className="md:col-span-4 sticky top-32 self-start">
//         <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-4xl font-medium text-[#1a1a1a] mb-6 leading-tight">
//           {title}
//         </h3>
//         <p className="text-gray-400 font-light text-sm tracking-wide leading-relaxed max-w-[280px]">
//           {desc}
//         </p>
...
//             className="mt-12 hidden md:block w-full aspect-[3/4] overflow-hidden grayscale brightness-95"
//           >
//             <img src={sideImage} className="w-full h-full object-cover" alt="Editorial" />
//           </motion.div>
//         )}
//       </div>
...
// export const CareerCTA = () => {
//   return (
//     <div className="bg-[#fafafa] text-[#1a1a1a] font-sans px-6 md:px-24 overflow-hidden">

//       {/* 1. Joining Guidelines */}
//       <Section
//         title="Joining Guidelines"
//         desc="Understand the step-by-step process to join SocialBureau."
//       >
//         <div className="grid md:grid-cols-12 gap-10 items-start">

//           {/* Image */}
//           <motion.div
//             className="md:col-span-5 w-full aspect-[4/5] overflow-hidden"
//             initial={{ clipPath: "inset(100% 0% 0% 0%)" }}
//             whileInView={{ clipPath: "inset(0% 0% 0% 0%)" }}
...
//                 whileHover={{ y: -6 }}
//                 className="group relative bg-white border border-gray-200 p-8 overflow-hidden"
//               >

//                 {/* Number */}
//                 <span className="absolute top-4 right-4 text-red-600 opacity-20 text-4xl font-serif italic">
//                   0{i + 1}
//                 </span>
...
//       >
//         <div className="mb-20">
//           <h3 style={{ fontFamily: "'Playfair Display', serif" }} className="text-5xl font-medium text-[#1a1a1a] mb-6 tracking-tight">Company Policy</h3>
//           <p className="text-gray-400 font-light tracking-[0.4em] uppercase text-[10px]">Our values, ethics, and professional expectations.</p>
//         </div>

//         <motion.div className="grid md:grid-cols-3 gap-1" variants={containerVariants}>
//           {policyData.map((item, i) => (
//             <motion.div
//               key={i}
//               variants={itemVariants}
//               className="group relative bg-white p-12 aspect-[4/5] flex flex-col justify-end overflow-hidden border border-gray-100"
//             >
//               {/* Image Background Hover Effect */}
//               <div className="absolute inset-0 z-0 scale-110 group-hover:scale-100 opacity-0 group-hover:opacity-10 transition-all duration-1000 ease-out">
//                 <img src={item.img} className="w-full h-full object-cover grayscale" alt="" />
//               </div>

//               <div className="relative z-10">
//                 <span className="text-[10px] uppercase tracking-[0.3em] text-red-600 font-bold block mb-6">Policy 0{i + 1}</span>
//                 <h4 className="text-2xl font-medium mb-4 font-serif leading-tight">{item.title}</h4>
//                 <p className="text-gray-400 text-sm leading-relaxed font-light italic group-hover:text-gray-600 transition-colors duration-500">
//                   {item.desc}
//                 </p>
//               </div>

//               {/* Bottom Decorative Bar */}
//               <div className="absolute bottom-0 left-0 h-1 w-0 bg-red-600 group-hover:w-full transition-all duration-700 ease-in-out" />
//             </motion.div>
//           ))}
//         </motion.div>
//       </motion.section>
...
//         initial="hidden"
//         whileInView="show"
//         className="py-48 text-center relative"
//       >
//         {/* Massive Background Text */}
//         <div className="absolute inset-0 flex items-center justify-center opacity-[0.02] pointer-events-none select-none">
//           <span className="text-[20vw] font-serif italic">SocialBureau</span>
//         </div>

//         <div className="relative z-10">
//           <h2 style={{ fontFamily: "'Playfair Display', serif" }} className="text-6xl md:text-8xl font-medium mb-16 tracking-tighter">
//             Ready to define <br /><span className="italic text-red-600">the future?</span>
//           </h2>
...
//             whileTap={{ scale: 0.95 }}
//             href="https://www.linkedin.com/company/socialbureau-in"
//             className="inline-block border border-[#1a1a1a] px-16 py-6 text-[11px] font-bold uppercase tracking-[0.5em] hover:bg-[#1a1a1a] hover:text-white transition-all duration-700 ease-out shadow-2xl"
//           >
//             Submit Application
//           </motion.a>
//         </div>
