        ...
        <section ref={targetRef} className="relative h-[400vh] bg-black">
            <div className="sticky top-0 flex h-screen items-center overflow-hidden">
                <motion.div style={{ x }} className="flex h-full">
                    ...
                    {/* End spacer to push content out */}
                    <div className="min-w-[50vw]" />
                </motion.div>

                {/* Static decorative elements */}
                <div className="absolute bottom-10 left-10 pointer-events-none opacity-30 hidden md:block">
                    <span className="text-[10px] tracking-[0.3em] uppercase font-bold text-zinc-500 rotate-90 origin-left inline-block">
                        Work Index / Selected Works
                    </span>
                </div>

                <div className="absolute bottom-10 right-10 pointer-events-none opacity-30">
                    <span className="text-[10px] tracking-[0.3em] uppercase font-bold text-zinc-500 inline-block">
                        Scroll to explore →
                    </span>
                </div>
            </div>
