...
// // // //     return (
// // // //         <div>
// // // //             <img src='/assets/landing.png' alt='Landing' className="w-full" />
// // // //         </div>
// // // //     );
// // // // };
...
// // //             {/* Tablet View */}
// // //             <img
// // //                 src='/assets/landing-tablet.png'
// // //                 alt='Landing Tablet'
// // //                 className="w-full h-auto hidden md:block lg:hidden object-cover"
// // //             />
...
// //     return (
// //         <section className="relative flex items-center justify-center h-screen overflow-hidden bg-gradient-to-br from-pink-100 to-red-200">
...
// //             `}</style>
// //             {/* TOOLTIP HINT */}
// //             <p className="absolute -bottom-10 text-[10px] uppercase tracking-[0.3em] font-bold text-red-500 animate-bounce">
// //                 Click to Heart
// //             </p>
...
// //                         {/* INVISIBLE CLICK ZONE (TOP OF HEART) */}
// //                         <button
// //                             onClick={handleBurst}
// //                             className="absolute top-[18%] w-40 h-32 z-30 cursor-pointer"
...
// //                             <div className="w-50 h-24 md:w-40 md:h-40 flex items-center justify-center overflow-hidden">
// //                                 <img
...
// //                 {burst && (
// //                     <span
// //                         className="absolute text-[350px] md:text-[500px] pointer-events-none"
...
//                         {/* TEXT HINT AT THE TOP OF THE HEART */}
//                         <p
//                             className="absolute -top-10 md:-top-16 text-[12px] md:text-[14px] uppercase tracking-[0.4em] font-black text-red-600 whitespace-nowrap"
...
//                         <button
//                             onClick={handleBurst}
//                             className="absolute top-[10%] w-60 h-60 z-30 cursor-pointer rounded-full"
//                             aria-label="Heart trigger"
//                         />
