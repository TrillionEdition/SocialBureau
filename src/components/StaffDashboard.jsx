...
export function StaffDashboard() {
  ...
  const ACHIEVEMENTS = [
    {
      title: "Top Performer",
      description: "Consistently exceeded targets",
    ...
    <>
      ...
      <div className="bg-black min-h-screen font-sans">
        ...
        <section className="max-w-full md:max-w-[80vw] mx-auto mt-4 md:mt-8 px-2">
          ...
          {/* ACHIEVEMENTS */}
          <div className="bg-gray-900 rounded-2xl p-6 md:p-8 mt-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl md:text-2xl font-bold text-white">
                Achievements
              </h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {ACHIEVEMENTS.map((item, idx) => (
                <div
                  key={idx}
                  className="bg-black border border-gray-700 rounded-xl p-4 flex flex-col items-center text-center hover:scale-105 transition-transform duration-300"
                >
