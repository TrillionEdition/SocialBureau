...
export const CyberBackground = () => {
  ...
  const desktopVideo = {
    ...
    mp4: "https://res.cloudinary.com/dtwcgfmar/video/upload/v1763017839/freepik__a-warm-cinematic-slowmotion-video-of-indian-school__31188_kqfvmy.mp4",
    poster: "/videos/hero-poster.jpg",
  };

  const mobileVideo = {
    webm: "/videos/hero-mobile.webm", // smaller/responsive mobile-optimized webm
    mp4: "https://res.cloudinary.com/dtwcgfmar/video/upload/v1763017826/freepik__a-warm-cinematic-slowmotion-video-of-indian-school__31190_poy8ia.mp4", // example mobile mp4
