...
// //                                 <img
// //                                     src="https://res.cloudinary.com/dtwcgfmar/image/upload/v1772185316/image-gen_8_sbd0tb.webp"
...
// //                             <h2 className="apple-heading text-4xl lg:text-5xl mb-10 text-black">Niche Marketing agency in Kochi</h2>
...
//                             Niche marketing service
//                         </h2>
//                         <p className="apple-body text-white/70 max-w-2xl mx-auto mb-8 sm:mb-10 lg:mb-12 text-sm sm:text-base lg:text-lg leading-relaxed">
//                             We design and implement marketing solutions that are built around precision
//                             rather than assumptions. Each service is delivered with research-backed
//                             planning, structured execution, and measurable outcomes
//                         </p>
...
//                     {/* TOP SECTION — Image + 3 stacked cards */}
//                     <div className="services-top-grid grid lg:grid-cols-2 gap-8 lg:gap-12 lg:gap-16 items-start mb-12 lg:mb-20">

//                         {/* Image Container */}
//                         <div className="relative group order-2 lg:order-1">
//                             <div className="absolute -inset-4 bg-white/[0.05] rounded-[2.5rem] blur-2xl group-hover:bg-white/[0.08] transition-all duration-700"></div>
//                             <div className="services-image relative h-64 sm:h-80 lg:h-[42rem] rounded-2xl lg:rounded-[2rem] overflow-hidden shadow-lg lg:shadow-2xl bg-white/5 border border-white/10">
//                                 <img
//                                     src="https://res.cloudinary.com/dtwcgfmar/image/upload/v1772185316/image-gen_8_sbd0tb.webp"
//                                     alt="Nichemarketing Services"
//                                     className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105"
...
//                         {/* Stacked cards (first 3 items) */}
//                         <div className="services-cards grid grid-cols-1 gap-6 sm:gap-7 lg:gap-8 order-1 lg:order-2">
//                             {processSections.slice(0, 3).map((section, index) => (
//                                 <div
//                                     key={index}
//                                     className="services-card group rounded-2xl lg:rounded-3xl p-6 sm:p-7 lg:p-8 bg-white/[0.03] backdrop-blur-xl border border-white/10 shadow-xl hover:bg-white/[0.07] hover:border-white/30 transition-all duration-500 hover:-translate-y-1"
//                                 >
//                                     <div className="flex items-start gap-6">
//                                         <div className="flex-shrink-0 text-white/20 text-3xl sm:text-4xl font-bold font-mono leading-none">
//                                             0{index + 1}
//                                         </div>
//                                         <div>
//                                             <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-white tracking-tight">
//                                                 {section.title}
//                                             </h3>
//                                             <p className="text-xs sm:text-sm text-white/60 leading-relaxed mb-4 sm:mb-6 group-hover:text-white/80 transition-colors">
//                                                 {section.content}
//                                             </p>
...
//                 <div className="max-w-7xl mx-auto">
//                     <div className="strategies-grid grid lg:grid-cols-2 gap-8 lg:gap-12 lg:gap-16 items-center">
//                         <div>
...
//                             </div>
//                         </div>
//                         <div className="strategies-image h-64 sm:h-80 lg:h-[600px] rounded-xl sm:rounded-2xl lg:rounded-[2rem] overflow-hidden shadow-lg lg:shadow-2xl relative group">
//                             <img
//                                 src="https://res.cloudinary.com/dtwcgfmar/image/upload/v1772088857/DSC04857_1_2_vksgod.webp"
//                                 alt="Professionals working at SocialBureau"
//                                 className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
...
const Niche = () => {
    ...
    return (
        <div className="font-['SF Pro Display', 'Inter', -apple-system, BlinkMacSystemFont, system-ui, sans-serif] bg-white text-[#1d1d1f] overflow-x-hidden antialiased relative">
            <Seo
                title="Niche Marketing Agency in Kerala | SocialBureau"
                url="https://www.socialbureau.inniche-marketing"
                canonicalUrl="https://www.socialbureau.inniche-marketing"
                description="Partner with a niche marketing agency that understands your audience and drives results through precision marketing"
                keywords="niche marketing, specialized marketing, kerala, Kochi, audience targeting,NICHE MARKETING AGENCY,NICHE MARKETING STRATEGIST,GROWTH STRATEGIES"
