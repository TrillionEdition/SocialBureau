...
//                         <div className="hidden md:flex items-center gap-4 lg:gap-8 text-xs text-gray-400">
//                             <span>COLLECTION / 2025</span>
//                             <div className="flex gap-3 lg:gap-4">
//                                 <a href="#" className="hover:text-lime-300 transition text-xs sm:text-sm">Designers</a>
//                                 <a href="#" className="hover:text-lime-300 transition text-xs sm:text-sm">Schedule</a>
//                                 <a href="#" className="hover:text-lime-300 transition text-xs sm:text-sm">Tickets</a>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
