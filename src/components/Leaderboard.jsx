...
// // //       // Fetch full team to ensure everyone is listed
...
// // //       // Create a map of team profiles for quick lookup
...
// // //       // 1. Start with everyone in the scoring data
// // //       const mergedList = lbUsers.map(lbUser => {
// // //         const userId = (lbUser._id || lbUser.id)?.toString();
// // //         const teamProfile = teamMap.get(userId);
// // //         return {
// // //           ...lbUser,
// // //           ...teamProfile, // Merge team info like coverImage, name, email
// // //           points: lbUser.points || 0,
// // //           id: userId
// // //         };
// // //       });

// // //       // 2. Add team members who aren't on the points leaderboard yet
...
// // //                     <span>💎</span> {formatNumber((second?.points || 0) * 10)}
// // //                   </div>
...
// // //                     <span className="text-blue-400">💎</span> {formatNumber((first?.points || 0) * 10)}
// // //                   </div>
...
// // //                 <div className="mt-2 md:mt-4 text-center">
// // //                   <div className="flex items-center gap-2 justify-center text-blue-400 text-xl md:text-2xl font-bold">
// // //                     <span>💎</span> {formatNumber((third?.points || 0) * 10)}
// // //                   </div>
// // //                   <span className="text-gray-600 text-[10px] uppercase tracking-widest mt-1 block">Prize</span>
// // //                 </div>
// // //               </div>
...
// // //             <div className="col-span-2 md:col-span-7">User</div>
...
// // //                     <div className="col-span-2 md:col-span-7 flex items-center gap-2 md:gap-4">
...
// // //                     <div className="col-span-1 md:col-span-2 text-white font-medium text-xs md:text-base text-center">
...
// // //                         <span>💎</span>
// // //                         <span className="text-white font-bold">{formatNumber((user.points || 0) * 10)}</span>
// // //                       </div>
// // //                     </div>
// // //                   </div>
// // //                 );
...
// //                 <div className="flex flex-col items-center gap-0.5 mt-1.5 sm:mt-4 pt-1.5 sm:pt-4 border-t border-white/10 w-full">
// //                   <Clock className="w-3 sm:w-5 h-3 sm:h-5 text-blue-400 mb-0.5" />
// //                   <span className="text-[8px] sm:text-[10px] text-gray-500 uppercase tracking-wider">Ends in</span>
// //                   <span className="text-white font-mono text-[8px] sm:text-sm tracking-wide">{timeLeft}</span>
// //                 </div>
// //               </div>
// //             </div>
// //           </div>
...
// //                   <div
// //                     key={user._id}
// //                     className={`grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-0 px-3 sm:px-6 lg:px-8 py-3 sm:py-5 items-start sm:items-center hover:bg-white/[0.02] transition-colors
// //                       ${isMe ? "bg-blue-500/5 hover:bg-blue-500/10" : ""}
// //                     `}
// //                   >
// //                     {/* Mobile Rank */}
// //                     <div className="sm:hidden font-bold text-white text-xs">#{rank}</div>

// //                     {/* Desktop Rank */}
// //                     <div className="hidden sm:block col-span-1 font-bold text-white text-lg">#{rank}</div>

// //                     {/* User Info */}
// //                     <div className="sm:col-span-7 flex items-center gap-2 sm:gap-4">
...
// //                           {user.name}
// //                         </div>
// //                         <div className="text-[9px] sm:text-xs text-gray-500 truncate">@{user.name.split(' ')[0].toLowerCase()}</div>
// //                       </div>
// //                     </div>

// //                     {/* Points and Reward - Mobile */}
// //                     <div className="sm:hidden flex justify-between items-center gap-2 w-full pt-2 border-t border-white/5">
// //                       <div>
// //                         <div className="text-[8px] text-gray-500 uppercase tracking-wider mb-1">Points</div>
// //                         <div className="text-white font-medium text-xs">{formatNumber(user.points || 0)}</div>
// //                       </div>
// //                       <div>
// //                         <div className="text-[8px] text-gray-500 uppercase tracking-wider mb-1">Reward</div>
// //                         <div className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[9px] bg-[#151E2E] border border-white/5">
// //                           <span>💎</span>
// //                           <span className="text-white font-bold">{formatNumber((user.points || 0) * 10)}</span>
// //                         </div>
// //                       </div>
...
// //                     {/* Points and Reward - Desktop */}
// //                     <div className="hidden sm:block sm:col-span-2 text-white font-medium text-base text-center">
// //                       {formatNumber(user.points || 0)}
// //                     </div>

// //                     <div className="hidden sm:block sm:col-span-2 text-right">
// //                       <div className="inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-2 rounded-lg bg-[#151E2E] border border-white/5 hover:bg-[#1A253A] transition-colors text-xs sm:text-sm">
// //                         <span>💎</span>
// //                         <span className="text-white font-bold">{formatNumber((user.points || 0) * 10)}</span>
// //                       </div>
// //                     </div>
