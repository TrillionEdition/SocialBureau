...
// //         try {
// //             await hrforumService.addMessage(applicationId, chatMsg, 'employer', currentUser?._id || currentUser?.id);
// //             setChatMsg("");
// //             fetchApplicationData();
// //         } catch (err) {
...
// //             <h2 className="text-3xl font-black text-gray-900 uppercase tracking-tighter mb-4">{error || "Access Denied"}</h2>
// //             <button onClick={() => navigate(-1)} className="bg-[#0e686eff] text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-[#0099a7d7] shadow-xl transition active:scale-95">
// //                 Go Back
// //             </button>
// //         </div>
// //     );

// //     const { candidateName, candidateEmail, candidatePhone, coverLetter, atsResult, status, jobId, messages = [], resumeUrl } = application;
...
// //                     </button>
// //                     <div>
// //                         <h1 className="text-3xl font-black uppercase tracking-tighter text-gray-900 mb-1 leading-none">{candidateName}</h1>
...
// //                         className={`px-8 py-4 rounded-[1.5rem] font-black uppercase tracking-widest text-[10px] transition-all flex items-center gap-3 border shadow-xl ${
// //                             showChat ? 'bg-[#0099a7d7] border-[#0099a7d7] text-white' : 'bg-white border-gray-100 text-gray-400 hover:text-[#0099a7d7] hover:border-[#0099a7d7]/20'
// //                         }`}
// //                     >
...
// //                             onClick={() => { setStatusAction('reject'); setStatusModalOpen(true); }}
...
// //                             onClick={() => { setStatusAction('shortlist'); setStatusModalOpen(true); }}
...
// //                             onClick={() => handleAction('selected', 'Congratulations! You have been selected for this position.')}
...
// //             {/* Split Layout */}
// //             <div className="max-w-[1700px] mx-auto p-12 grid grid-cols-12 gap-12">

// //                 {/* LEFT: Candidate Profile */}
// //                 <div className="col-span-12 lg:col-span-8 space-y-12">
// //                     <div className="bg-white rounded-[4rem] border border-gray-100 shadow-2xl p-16 relative overflow-hidden group">
// //                         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0099a7d7]/2 rounded-full blur-[120px] -z-10 -mr-64 -mt-64 opacity-50 group-hover:opacity-100 transition-opacity"></div>

// //                         <div className="border-b border-gray-50 pb-12 mb-12 flex justify-between items-start">
// //                             <div>
// //                                 <h1 className="text-6xl font-black uppercase tracking-tighter mb-4 text-gray-900 leading-none">{candidateName}</h1>
// //                                 <div className="flex flex-wrap gap-8 text-gray-400 text-[10px] font-black uppercase tracking-widest">
// //                                     <span className="flex items-center gap-2"><Mail size={18} className="text-[#0099a7d7]" /> {candidateEmail}</span>
// //                                     <span className="flex items-center gap-2"><Phone size={18} className="text-[#0099a7d7]" /> {candidatePhone || "Not provided"}</span>
// //                                     <span className="flex items-center gap-2"><Clock size={18} className="text-[#0099a7d7]" /> Applied {new Date(application.appliedAt).toLocaleDateString()}</span>
// //                                 </div>
// //                             </div>
...
// //                                         className="flex items-center gap-3 px-8 py-4 bg-[#0e686eff] text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-teal-900/10 hover:bg-[#0099a7d7] transition-all active:scale-95"
// //                                     >
...
// //                             <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] mb-8">Cover Letter</h3>
// //                             <p className="text-2xl font-medium text-gray-600 leading-relaxed italic border-l-8 border-[#0099a7d7]/20 pl-12 py-12 bg-[#f8fafc] rounded-r-[3rem]">
...
// //                         {/* ATS Analysis */}
// //                         <section className="mb-16">
// //                             <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] mb-10">ATS Analysis</h3>
// //                             <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
// //                                 <div className="p-10 bg-[#f8fafc] rounded-[3rem] border border-gray-100 shadow-inner">
// //                                     <h4 className="flex items-center gap-3 text-[11px] font-black uppercase tracking-widest mb-8 text-emerald-600">
// //                                         <CheckCircle size={18} /> Matches
// //                                     </h4>
// //                                     <div className="flex flex-wrap gap-3">
// //                                         {(atsResult?.matchedSkills || atsResult?.keywordMatches)?.length > 0 ? (
// //                                             (atsResult?.matchedSkills || atsResult?.keywordMatches).map((s, i) => (
// //                                                 <span key={i} className="px-5 py-2.5 bg-white border-2 border-emerald-50 text-emerald-700 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-sm">{s}</span>
// //                                             ))
// //                                         ) : (
// //                                             <span className="text-[10px] font-bold text-gray-400 italic">No direct matches found.</span>
// //                                         )}
// //                                     </div>
// //                                 </div>
// //                                 <div className="p-10 bg-[#f8fafc] rounded-[3rem] border border-gray-100 shadow-inner">
// //                                     <h4 className="flex items-center gap-3 text-[11px] font-black uppercase tracking-widest mb-8 text-red-600">
// //                                         <AlertTriangle size={18} /> Missing Skills
// //                                     </h4>
// //                                     <div className="flex flex-wrap gap-3 opacity-60">
// //                                         {atsResult?.missingKeywords?.length > 0 ? (
// //                                             atsResult.missingKeywords.map((s, i) => (
// //                                                 <span key={i} className="px-5 py-2.5 bg-white border-2 border-red-50 text-red-800 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-sm">{s}</span>
// //                                             ))
// //                                         ) : (
// //                                             <span className="text-[10px] font-bold text-gray-400 italic">No major missing skills identified.</span>
// //                                         )}
// //                                     </div>
// //                                 </div>
// //                             </div>
...
// //                             <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] mb-12">Resume Viewer</h3>
// //                             {resumeUrl ? (
// //                                 <div className="w-full h-[1000px] bg-gray-100 rounded-[3rem] border-4 border-gray-50 overflow-hidden shadow-inner">
// //                                     <iframe 
...
// //                                     <p className="font-black uppercase tracking-widest text-gray-400 text-sm">No Resume Document Available</p>
// //                                 </div>
// //                             )}
// //                         </section>
// //                     </div>
...
// //                 {/* RIGHT: Dashboard */}
// //                 <div className="col-span-12 lg:col-span-4 space-y-12 lg:sticky lg:top-48 h-fit">

// //                     {/* Match Score */}
// //                     <div className="bg-white rounded-[4rem] p-12 border border-gray-100 shadow-2xl relative overflow-hidden group">
// //                         <div className="absolute top-0 right-0 w-64 h-64 bg-[#0099a7d7]/5 rounded-full blur-3xl -z-10 -mr-32 -mt-32"></div>
// //                         <div className="flex justify-between items-center mb-12">
// //                             <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em]">Match Score</h3>
// //                             <Zap size={24} className="text-[#0099a7d7] fill-current" />
// //                         </div>
// //                         <div className="flex flex-col items-center">
// //                             <div className="relative w-64 h-64 flex items-center justify-center mb-10 translate-y-[-10px]">
// //                                 <svg className="w-full h-full transform -rotate-90">
// //                                     <circle cx="128" cy="128" r="110" className="stroke-[#f8fafc] fill-none" strokeWidth="20" />
// //                                     <circle 
// //                                         cx="128" 
// //                                         cy="128" 
// //                                         r="110" 
// //                                         className="stroke-[#0e686eff] fill-none transition-all duration-1000 ease-out" 
// //                                         strokeWidth="20" 
// //                                         strokeDasharray={691.15}
// //                                         strokeDashoffset={691.15 - (691.15 * (atsResult?.score || 0)) / 100}
// //                                         strokeLinecap="round"
// //                                     />
// //                                 </svg>
// //                                 <div className="absolute flex flex-col items-center">
// //                                     <span className="text-7xl font-black tracking-tighter text-gray-900 leading-none">{atsResult?.score || 0}%</span>
// //                                     <span className="text-[10px] font-black text-[#0099a7d7] uppercase tracking-widest mt-3">{atsResult?.score > 80 ? "EXCELLENT" : "GOOD"} MATCH</span>
// //                                 </div>
// //                             </div>
// //                             <p className="text-center font-bold text-gray-400 px-12 leading-relaxed italic text-xs uppercase tracking-tight">
// //                                 {atsResult?.summary || "No automated summary available for this profile."}
// //                             </p>
// //                         </div>
// //                     </div>
...
// //                             <div className="w-20 h-20 bg-[#f8fafc] rounded-3xl flex items-center justify-center text-[#0e686eff] shadow-inner border border-gray-50">
// //                                 <Briefcase size={32} />
// //                             </div>
// //                             <div>
// //                                 <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-1">Target Role</h3>
// //                                 <p className="font-black text-gray-900 uppercase tracking-tight text-2xl leading-none">{jobId?.jobTitle}</p>
// //                             </div>
// //                         </div>

// //                         <div className="space-y-10">
// //                             <div className="p-8 bg-[#f8fafc] rounded-[2.5rem] border border-gray-100">
// //                                 <h4 className="text-[9px] font-black text-[#0099a7d7] uppercase tracking-widest mb-4 flex items-center gap-2"><Info size={14} /> Job Description</h4>
// //                                 <p className="text-gray-500 text-xs font-bold leading-relaxed italic border-l-4 border-[#0099a7d7]/10 pl-6">
// //                                     {jobId?.description?.substring(0, 300)}...
// //                                 </p>
// //                             </div>
// //                         </div>
// //                     </div>
...
// //             {/* Sidebar Chat */}
// //             <div className={`fixed inset-y-0 right-0 w-full md:w-[600px] bg-white z-[100] transform transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] border-l border-gray-50 flex flex-col shadow-[0_0_100px_rgba(0,0,0,0.1)] ${
...
// //                         </div>
// //                         <div>
// //                             <h3 className="font-black uppercase tracking-tight text-gray-900 text-2xl">{candidateName}</h3>
// //                             <p className="text-[10px] font-black text-[#0099a7d7] uppercase tracking-widest flex items-center gap-3">
// //                                 <div className="w-2.5 h-2.5 bg-[#0099a7d7] rounded-full animate-pulse shadow-[0_0_15px_rgba(0,153,167,0.6)]"></div> Online
// //                             </p>
// //                         </div>
// //                     </div>
// //                     <button onClick={() => setShowChat(false)} className="w-16 h-16 bg-[#f8fafc] hover:bg-white rounded-2xl flex items-center justify-center transition-all border border-gray-100 text-gray-300 hover:text-red-500 shadow-inner">
// //                         <X size={32} />
// //                     </button>
// //                 </div>
...
// //                                 <div className={`max-w-[85%] p-10 rounded-[3rem] shadow-2xl border relative ${
...
// //                                     <span className={`text-[9px] font-black uppercase tracking-widest mt-6 block ${
// //                                         m.senderRole === 'employer' ? 'text-white/40' : 'text-gray-300'
// //                                     }`}>
...
// //                 <form onSubmit={handleSendMessage} className="p-12 bg-white border-t border-gray-50 flex gap-6 items-end shadow-inner">
// //                     <textarea 
// //                         value={chatMsg}
...
// //                     />
// //                     <button type="submit" className="bg-[#0e686eff] hover:bg-[#0099a7d7] text-white p-8 rounded-[2rem] transition-all shadow-2xl shadow-teal-900/10 active:scale-95 group">
...
// //     const [fullscreenResume, setFullscreenResume] = useState(false);
...
// //         messages = [],
// //         resumeUrl,
// //         resumeFile // Alternative field for resume
// //     } = application;

// //     // Determine the actual resume URL - Handle backend file paths
// //     const getResumeUrl = () => {
// //         const fileUrl = resumeUrl || resumeFile;
...
// //         // If it contains "Upload:" prefix, remove it and construct backend URL
// //         let fileName = fileUrl;
// //         if (fileUrl.includes('Upload:')) {
// //             fileName = fileUrl.replace('Upload:', '').trim();
// //         }

// //         // Construct the backend URL - CHANGE THIS TO YOUR BACKEND URL
// //         const backendUrl = process.env.BASE_URL || 'http://localhost:5000'; // Adjust port if needed
// //         return `${backendUrl}/api/uploads/${fileName}`;
// //     };

// //     const actualResumeUrl = getResumeUrl();
...
// //                             }}
// //                             className={`px-6 py-4 bg-white border border-gray-100 rounded-[1.2rem] text-[9px] font-black uppercase tracking-widest text-gray-400 hover:bg-red-50 hover:text-white hover:border-red-500 transition-all flex items-center gap-2 ${
...
// //                                 setStatusModalOpen(true);
// //                             }}
// //                             className={`px-6 py-4 bg-white border border-gray-100 rounded-[1.2rem] text-[9px] font-black uppercase tracking-widest text-gray-400 hover:bg-[#0099a7d7] hover:border-[#0099a7d7] hover:text-white transition-all flex items-center gap-2 ${
// //                                 status === 'shortlisted' ? 'bg-[#0099a7d7] text-white' : ''
// //                             }`}
// //                         >
// //                             <CheckCircle size={18} /> {status === 'shortlisted' ? 'Shortlisted' : 'Shortlist'}
// //                         </button>
...
// //                                 )
// //                             }
// //                             className={`px-8 py-4 bg-[#0e686eff] text-white rounded-[1.2rem] text-[9px] font-black uppercase tracking-widest hover:bg-[#0099a7d7] shadow-xl transition-all flex items-center gap-2 active:scale-95 shadow-teal-900/10 ${
// //                                 status === 'selected' ? 'ring-4 ring-[#0099a7d7]/50' : ''
// //                             }`}
// //                         >
// //                             <ShieldCheck size={18} /> {status === 'selected' ? 'Hired ✓' : 'Accept'}
// //                         </button>
...
// //                                             <iframe
// //                                                 ref={iframeRef}
// //                                                 src={`${actualResumeUrl}#toolbar=1&navpanes=0&scrollbar=1`}
...
// //                                         The resume file could not be located. Check that the URL is correct.
// //                                     </p>
// //                                     {/* Debug info */}
// //                                     <div className="text-left bg-gray-100 p-4 rounded-lg text-[8px] font-mono text-gray-600 max-h-32 overflow-y-auto mb-4 border border-gray-200">
...
// //                                         <p className="mb-1"><span className="font-bold">Backend URL:</span> {process.env.REACT_APP_API_URL || 'http://localhost:5000'}</p>
// //                                         <p className="text-yellow-600 mt-2"><span className="font-bold">⚠️ IMPORTANT:</span> If the constructed URL is wrong, update your backend URL in:</p>
// //                                         <p className="text-yellow-600 font-bold">.env file: REACT_APP_API_URL=your_backend_url</p>
// //                                     </div>
// //                                     <button
// //                                         onClick={() => {
// //                                             console.log("Current Application:", application);
// //                                             console.log("Resume URL:", resumeUrl);
// //                                             console.log("Constructed URL:", actualResumeUrl);
// //                                             alert("Check browser console for full application data");
// //                                         }}
// //                                         className="bg-[#0e686eff] text-white px-4 py-2 rounded-lg text-[9px] font-bold uppercase"
// //                                     >
// //                                         Log Data to Console
// //                                     </button>
// //                                 </div>
...
// //             {/* Sidebar Chat */}
// //             <div
// //                 className={`fixed inset-y-0 right-0 w-full md:w-[600px] bg-white z-[100] transform transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] border-l border-gray-50 flex flex-col shadow-[0_0_100px_rgba(0,0,0,0.1)] ${
// //                     showChat ? 'translate-x-0' : 'translate-x-full'
// //                 }`}
// //             >
// //                 <div className="p-12 border-b border-gray-50 flex items-center justify-between bg-white relative">
...
// //                             <div key={i} className={`flex ${m.senderRole === 'employer' ? 'justify-end' : 'justify-start'}`}>
// //                                 <div
// //                                     className={`max-w-[85%] p-10 rounded-[3rem] shadow-2xl border relative ${
// //                                         m.senderRole === 'employer'
// //                                             ? 'bg-[#0e686eff] border-[#0099a7d7]/10 text-white rounded-tr-none'
// //                                             : 'bg-white text-gray-600 border-gray-100 rounded-tl-none shadow-sm'
// //                                     }`}
...
// //                                     <p className="font-bold leading-relaxed text-sm">{m.content}</p>
// //                                     <span
// //                                         className={`text-[9px] font-black uppercase tracking-widest mt-6 block ${
// //                                             m.senderRole === 'employer' ? 'text-white/40' : 'text-gray-300'
// //                                         }`}
// //                                     >
...
//         // Construct the backend URL - CHANGE THIS TO YOUR BACKEND URL
//         return `${BASE_URL}/api/uploads/${fileName}`;
//     };
...
export default function CandidateProfile() {
    ...
    const getResumeUrl = (rawUrl) => {
        ...
        // Construct URL using BASE_URL (should be http://localhost:5000 or your production URL)
        // This matches the backend: `http://localhost:5000/uploads/${fileName}`
