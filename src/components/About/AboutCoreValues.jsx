...
//           viewport={{ once: true }}
//           className="text-[#8D0F16] font-bold uppercase tracking-widest text-center mb-4"
//         >
//           What drives us
//         </motion.p>
//         <motion.h2
...
//           viewport={{ once: true }}
//           className="text-3xl sm:text-4xl md:text-7xl font-black tracking-tighter text-white text-center mb-12 sm:mb-24"
//         >
...
//               viewport={{ once: true }}
//               whileHover={{ y: -15 }}
//               className="bg-[#0a0a0a] border border-white/5 rounded-[1.5rem] sm:rounded-[2.5rem] p-5 sm:p-10 flex flex-col items-center text-center shadow-2xl hover:border-[#8D0F16]/20 transition-all duration-500 group"
//             >
//               <div className="w-10 h-10 sm:w-16 sm:h-16 mb-4 sm:mb-8 flex items-center justify-center p-2 sm:p-3 bg-[#111] rounded-xl sm:rounded-2xl shadow-inner group-hover:scale-110 transition-transform">
//                 <img src={val.icon} alt={val.title} className="w-full h-full object-contain brightness-0 invert" />
//               </div>
//               <h3 className="text-base sm:text-xl font-black tracking-tight text-white mb-2 sm:mb-4 leading-tight group-hover:text-[#8D0F16] transition-colors">
//                 {val.title}
//               </h3>
//               <p className="text-[13px] sm:text-[15px] text-white/50 leading-relaxed font-medium group-hover:text-white/80 transition-colors">
//                 {val.desc}
//               </p>
