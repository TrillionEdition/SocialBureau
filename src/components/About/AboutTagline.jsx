...
//       {/* HERO SECTION */}
//       <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 pt-20 pb-20 md:pt-32 md:pb-32">
...
//           viewport={{ once: true }}
//           className="text-[14px] sm:text-[16px] font-bold text-[#8D0F16] tracking-[0.2em] uppercase mb-8"
//         >
//           Our Mission
//         </motion.p>
...
//           viewport={{ once: true }}
//           className="max-w-4xl w-full text-[16px] sm:text-[18px] md:text-[22px] font-medium text-white/70 leading-[1.6]"
