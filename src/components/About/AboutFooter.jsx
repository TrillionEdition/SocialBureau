...
// // // import { ShieldCheck, BarChart3, TrendingUp, Scale, Eye } from 'lucide-react';
...
// // // const AboutFooter = () => {
// // //   return (
// // //     <div className="bg-[#8D0F16] text-white overflow-hidden">
// // //       {/* HERO */}
// // //       <section className="py-16 sm:py-32 md:py-48 px-4 sm:px-6 text-center border-b border-white/20">
...
// // //             viewport={{ once: true }}
// // //             className="text-[14px] sm:text-[18px] font-black text-white/80 uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-6 sm:mb-8"
// // //           >
...
// // //             viewport={{ once: true }}
// // //             className="text-[32px] sm:text-[48px] md:text-[100px] font-black tracking-[-0.04em] leading-[0.9] text-white mb-6 sm:mb-10"
// // //           >
// // //             Trust is built on
// // //             <br />
...
// // //             viewport={{ once: true }}
// // //             className="text-[18px] sm:text-[22px] md:text-[28px] text-white/80 font-medium leading-[1.4] max-w-2xl mx-auto"
// // //           >
...
// // //       {/* TRUST POINTS */}
// // //       <section className="px-4 sm:px-6 max-w-[1100px] mx-auto py-16 sm:py-32">
...
// // //             viewport={{ once: true }}
// // //             className={`grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-12 py-8 sm:py-16 ${i < trustPoints.length - 1
// // //               ? 'border-b border-white/10'
// // //               : ''
// // //               } group`}
// // //           >
// // //             {/* Number + Icon */}
// // //             <div className="md:col-span-2 flex flex-row md:flex-col items-center md:items-start gap-4 sm:gap-6">
// // //               <span className="text-[14px] font-black tracking-[0.2em] text-white/40 group-hover:text-black transition-colors">
// // //                 {point.id}
// // //               </span>
// // //               <div className="p-4 bg-white/10 rounded-2xl group-hover:bg-white group-hover:text-[#8D0F16] transition-all duration-500 transform group-hover:rotate-12">
// // //                 {point.icon}
// // //               </div>
// // //             </div>
...
// // //               <h3 className="text-[20px] sm:text-[24px] md:text-[32px] font-black tracking-tight leading-[1.2] text-white group-hover:text-black transition-colors">
// // //                 {point.title}
// // //               </h3>
// // //             </div>
...
// // //               <p className="text-[15px] sm:text-[18px] md:text-[20px] text-white/70 leading-[1.6] font-medium group-hover:text-white transition-colors">
// // //                 {point.content}
// // //               </p>
// // //             </div>
// // //           </motion.div>
...
// // //       {/* CTA */}
// // //       <section className="py-20 sm:py-40 px-4 sm:px-6 border-t border-white/20 text-center bg-black">
// // //         <motion.div
...
// // //         >
// // //           <h3 className="text-[28px] sm:text-[40px] md:text-[72px] font-black tracking-[-0.03em] text-white mb-6 sm:mb-8 leading-[1.05]">
// // //             Experience <span className="text-[#8D0F16]">strategic</span> clarity.
// // //           </h3>
// // //           <p className="text-[16px] sm:text-[20px] md:text-[26px] text-white/60 mb-10 sm:mb-16 leading-[1.6] max-w-2xl mx-auto">
// // //             Partner with a team that turns data into decisions and decisions into growth.
// // //           </p>
// // //           <a href="/contact">
// // //             <button className="bg-[#8D0F16] text-white px-10 sm:px-16 py-4 sm:py-6 rounded-full text-[16px] sm:text-[20px] font-black hover:bg-white hover:text-[#8D0F16] transition-all transform hover:scale-110 shadow-[0_0_40px_rgba(156,31,30,0.4)] uppercase tracking-widest">
// // //               Partner with us
// // //             </button>
// // //           </a>
// // //         </motion.div>
...
// //             transition={{ duration: 0.6, delay: 0.3 }}
// //             viewport={{ once: true }}
// //             className="text-[16px] sm:text-[18px] md:text-[22px] text-white/80 font-medium leading-[1.6] max-w-2xl mx-auto"
// //           >
// //             Credibility earned through experience, performance, and transparency.
// //           </motion.p>
// //         </div>
...
// //             transition={{ duration: 0.8, delay: i * 0.1 }}
// //             viewport={{ once: true }}
// //             className={`${i < trustPoints.length - 1 ? 'border-b border-white/10' : ''} group`}
// //           >
// //             {/* ── DESKTOP LAYOUT (md+) ── */}
...
// //                 <span className="text-[14px] sm:text-[16px] font-bold tracking-[0.2em] text-white/40 group-hover:text-black transition-colors">
// //                   {point.id}
// //                 </span>
// //                 <div className="p-4 bg-white/10 rounded-2xl group-hover:bg-white group-hover:text-[#8D0F16] transition-all duration-500 transform group-hover:rotate-12">
// //                   {point.icon}
...
// //               {/* Title */}
// //               <div className="md:col-span-4">
// //                 <h3 className="text-[18px] sm:text-[20px] md:text-[24px] font-bold tracking-tight leading-[1.2] text-white group-hover:text-black transition-colors">
// //                   {point.title}
// //                 </h3>
// //               </div>
...
// //               {/* Full Content */}
// //               <div className="md:col-span-6">
// //                 <p className="text-[14px] sm:text-[15px] md:text-[18px] text-white/70 leading-[1.6] font-medium group-hover:text-white transition-colors">
// //                   {point.content}
// //                 </p>
// //               </div>
// //             </div>
...
// //                     <span className="text-[14px] sm:text-[16px] font-bold tracking-[0.2em] text-white/40">
// //                       {point.id}
// //                     </span>
// //                     <div
// //                       className={`p-3 rounded-xl transition-all duration-300 ${openIndex === i
// //                         ? 'bg-white text-[#8D0F16]'
...
// //                 {/* Title */}
// //                 <h3 className="text-[18px] sm:text-[20px] md:text-[24px] font-bold tracking-tight leading-[1.2] text-white">
// //                   {point.title}
// //                 </h3>

// //                 {/* Preview text — always visible */}
// //                 <p className="text-[13px] sm:text-[14px] text-white/60 leading-[1.5] font-medium">
// //                   {point.preview}
// //                 </p>
// //               </button>
...
// //                   >
// //                     <p className="pb-6 text-[14px] sm:text-[15px] md:text-[18px] text-white/75 leading-[1.65] font-medium border-t border-white/10 pt-4">
// //                       {point.content}
// //                     </p>
// //                   </motion.div>
// //                 )}
...
//       <section className="bg-white px-4 sm:px-6 max-w-[1100px] mx-auto py-16 sm:py-32">
//         {trustPoints.map((point, i) => (
//           <motion.div
//             key={point.id}
//             initial={{ opacity: 0, x: i % 2 === 0 ? -50 : 50 }}
