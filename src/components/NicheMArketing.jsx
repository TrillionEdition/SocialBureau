...
// //                 description="Niche Marketing Agency in Kerala helping brands dominate
// //                 their niche through data driven strategy, stronger conversions, and long term
// //                 business growth"
...
// //                         </p>
// //                         <p className="text-[#BFBFBF] mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
// //                             At <span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.8 }} className="text-gray-200 text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-8 sm:mb-10 font-light leading-relaxed">

// //                                 <a style={{ fontFamily: "MyFont, sans-serif" }} href='https://socialbureau.in'>

// //                                     Social<span className="text-[#ff0000]">B</span>ureau

// //                                 </a></span>, a Kochi-based marketing agency, we work with businesses that want to grow through specialization. Our team studies how audiences think, search, and make decisions, then builds structured marketing systems that support long-term positioning and consistent demand.
// //                         </p>
...
// //                     Let's discuss how <a href='https://en.wikipedia.org/wiki/Niche_market' className='text-red-400'> Niche marketing </a> can drive sustainable growth and establish clear positioning for your business.
// //                 </p>
...
//                             >
//                                 {/* Number Badge */}
//                                 <div className="absolute -top-4 -right-4 w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#C0C0C0] to-[#808080] rounded-full flex items-center justify-center text-[#0F0F0F] font-['Syne'] font-bold text-2xl sm:text-3xl shadow-lg">
//                                     {strategy.number}
//                                 </div>
