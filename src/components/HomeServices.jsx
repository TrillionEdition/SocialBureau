 ...
 * Displays a list of core services in a interactive pill-shaped design
 * connecting to a central intelligence hub.
 */
export default function HomeServices() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-[90vh] bg-[#050505] overflow-hidden flex items-center py-10 lg:py-20">
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10 w-full service-container">
          ...
          <div className="w-full lg:w-3/5 flex flex-col gap-6">
            <div className="mb-10 text-center lg:text-left">
              <h2 className="text-4xl lg:text-7xl font-extrabold text-white mb-6 tracking-tight">
                Core <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500">Services</span>
              </h2>
