  ...
  columns: [
    {
      ...
      items: [
        ...
        { label: "PDF to Images", href: "/pdf-tools/pdf-to-images" },
        { label: "Images to PDF", href: "/pdf-tools/images-to-pdf" },
        { label: "PDF to Word", href: "/pdf-tools/pdf-to-word" },
        { label: "Word to PDF", href: "/pdf-tools/word-to-pdf" },
        { label: "PDF to Text", href: "/pdf-tools/pdf-to-text" },
      ],
    },
    {
      title: "IMAGE TOOLKIT",
      items: [
        { label: "Resize Image", href: "/image-tools/resize-image" },
        { label: "Compress Image", href: "/image-tools/compress-image" },
        { label: "Convert Image Format", href: "/image-tools/convert-image-format" },
        { label: "Rotate Image", href: "/image-tools/rotate-image" },
        { label: "Grayscale Image", href: "/image-tools/grayscale-image" },
      ],
    },
  ],
},
