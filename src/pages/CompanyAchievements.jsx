...
//                     <h2 className="text-blue-500 font-bold tracking-[0.2em] uppercase text-sm mb-4 animate-fade-in">
//                         Our Journey of Excellence
//                     </h2>
//                     <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-b from-white to-zinc-500 bg-clip-text text-transparent">
...
//                         </div>
//                     ) : (
//                         <div className="text-center py-20 bg-zinc-900/30 rounded-3xl border border-zinc-800 backdrop-blur-sm">
//                             <div className="text-6xl mb-4">🏆</div>
//                             <h3 className="text-xl font-bold text-zinc-300">No achievements recorded yet</h3>
//                             <p className="text-zinc-500 mt-2">Check back soon to see our latest milestones!</p>
//                         </div>
//                     )}
//                 </div>
