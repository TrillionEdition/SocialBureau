...
//             className="w-full rounded-xl border border-gray-700 bg-black px-4 py-3" required />

//           <input name="icon" placeholder="FontAwesome Icon" onChange={handleChange}
...
//           <input name="employment" placeholder="Employment Type" onChange={handleChange}
//             className="w-full rounded-xl border border-gray-700 bg-black px-4 py-3" />

//           <input name="salary" placeholder="Salary" onChange={handleChange}
//             className="w-full rounded-xl border border-gray-700 bg-black px-4 py-3" />

//           <input name="link" placeholder="Apply Link (Google Form)" onChange={handleChange}
//             className="w-full rounded-xl border border-gray-700 bg-black px-4 py-3" />
...
//           <textarea name="about" placeholder="About Role" onChange={handleChange}
//             className="h-28 w-full rounded-xl border border-gray-700 bg-black px-4 py-3" />

//           <textarea name="nextSteps" placeholder="Next Steps" onChange={handleChange}
//             className="h-24 w-full rounded-xl border border-gray-700 bg-black px-4 py-3" />
