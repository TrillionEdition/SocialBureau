...
//                                         className={`flex items-center gap-2 p-3 rounded-xl border transition-all ${sectionType === type.value
...
//                                         <div key={idx} className={`p-4 rounded-xl border ${tip.priority === 'high'
//                                                 ? 'bg-red-500/10 border-red-500/20'
//                                                 : 'bg-yellow-500/10 border-yellow-500/20'
//                                             }`}>
//                                             <p className={`text-sm font-medium ${tip.priority === 'high' ? 'text-red-300' : 'text-yellow-300'
//                                                 }`}>
